...
export default function TutoresFilters() {
    ...
    const hasFilters = localSearch || localSinEmail
    ...
    return (
        <div className="bg-white rounded-2xl border border-slate-200 p-5 flex flex-wrap gap-4 items-center">
            ...
            <label className="flex items-center gap-2 cursor-pointer select-none">
                ...
                />
                <span className="text-sm font-medium text-slate-600">Sin email tutor</span>
            </label>
            {hasFilters && (
