...
export default async function RetrasosHistorialPage(props: { searchParams: Promise<{ q?: string, curso?: string, fecha?: string, page?: string, limit?: string }> }) {
    ...
    return (
        <div className="space-y-2 -mt-4 pb-4">
            ...
            <AdvancedFilter baseUrl="/retrasos/historial" unidades={unidades} />
