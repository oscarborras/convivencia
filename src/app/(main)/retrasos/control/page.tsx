...
export default function RetrasosControlPage() {
    ...
    const fetchRetrasos = useCallback(async () => {
        ...
        try {
            ...
            if (data) {
                ...
                // 1. Filtro por estado de sanción
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-3 -mt-6 pb-4 animate-in fade-in duration-500">
            {/* Cabecera */}
            <div className="bg-white rounded-3xl p-5 border-t-4 border-indigo-500 shadow-sm relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Control de Retrasos</h1>
                        </div>
                    </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50/50">
                                <th className="px-6 py-2.5 text-xs font-black text-gray-400 uppercase tracking-widest border-b border-gray-100">Alumno/a</th>
                                <th className="px-6 py-2.5 text-xs font-black text-gray-400 uppercase tracking-widest border-b border-gray-100">Curso</th>
                                <th className="px-6 py-2.5 text-xs font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-center">Justificados</th>
                                <th className="px-6 py-2.5 text-xs font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-center">Sin Justificar</th>
                                <th className="px-6 py-2.5 text-xs font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-center">Sancionables</th>
                                <th className="px-6 py-2.5 text-xs font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-center">Total</th>
                            </tr>
                        </thead>
                                ...
                                alumnos.map((alu) => (
                                    ...
                                    >
                                        <td className="px-4 py-1.5">
                                            <div className="flex items-center gap-3">
                                                <div className="bg-gray-100 p-2 rounded-xl text-gray-500 group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm">
                                                    <User className="w-3.5 h-3.5" />
                                                </div>
                                                <span className="font-bold text-gray-900 text-xs group-hover:text-indigo-700 transition-colors">{alu.alumno}</span>
                                            </div>
                                        </td>
                                        <td className="px-4 py-1.5 text-xs text-gray-600 font-medium">{alu.unidad}</td>
                                        <td className="px-4 py-1.5 text-center">
                                            <div className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-700 px-3 py-1 rounded-full text-[11px] font-bold border border-emerald-100/50">
                                        ...
                                        <td className="px-4 py-1.5 text-center">
                                            <span className="text-base font-black text-indigo-600 bg-indigo-50 w-8 h-8 inline-flex items-center justify-center rounded-xl shadow-sm border border-indigo-100 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                                                {alu.total}
                                            </span>
                                        </td>
                                    </tr>
                    ...
                    <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                disabled={page === 1}
                                className="p-2 rounded-xl border border-gray-200 bg-white text-gray-500 hover:text-indigo-600 hover:border-indigo-100 disabled:opacity-50 cursor-pointer transition-all"
                            >
