...
export default function PartesControlPage() {
                    ...
                    <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                disabled={page === 1}
                                className="p-2 rounded-xl border border-gray-200 bg-white text-gray-500 hover:text-rose-600 hover:border-rose-100 disabled:opacity-50 cursor-pointer transition-all"
                            >
