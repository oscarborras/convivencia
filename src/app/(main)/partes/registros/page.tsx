...
export default async function PartesRegistrosPage(props: { searchParams: Promise<{ q?: string, curso?: string, fecha?: string, page?: string, limit?: string }> }) {
    ...
    return (
        <div className="space-y-2 -mt-4 pb-4">
            ...
            <AdvancedFilter baseUrl="/partes/registros" unidades={unidades} />
